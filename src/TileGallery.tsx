'use strict';
import {StyleSheet, View, Text, Pressable, ScrollView, Linking, PlatformColor, Image} from 'react-native';
...
const HeaderTile = (props: HeaderTileType): JSX.Element => {
  ...
  return (
    <Pressable
      ...
      <View style={styles.tileIconContent}>
        {props.children}
      </View>
...
const TileGallery = () => {
  ...
  return (
    <ScrollView horizontal={true}>
      <View style={styles.tileGalleryContainer}>
        <HeaderTile
        ...
        <HeaderTile
          title="React Native for Windows GitHub"
          description="The latest Windows native controls and styles for your applications."
